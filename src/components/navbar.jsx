        ...
        <nav className={navClasses} style={navStyle}>
            ...
            <div className="flex-1 flex items-center justify-end space-x-2 lg:space-x-3 xl:space-x-4 relative z-10">
                ...
                <div className="hidden xl:flex items-center gap-2">
                    {/* Google Play Button */}
                    <div className="flex bg-black px-2.5 py-1.5 text-left rounded-lg items-center w-[140px] cursor-pointer hover:bg-black/90 transition-all shadow-sm flex-shrink-0">
                    ...
                    >
                        <div className="flex flex-col space-y-4">
                            ...
                            <div className="pt-4 border-t border-gray-200 flex flex-col gap-2">
                                {/* Google Play Button */}
                                <div className="flex bg-black p-2 text-left rounded-lg items-center cursor-pointer hover:bg-black/90 transition-all shadow-sm">
