    ...
    return (
        <div className="flex flex-col items-center justify-center gap-15 lg:gap-20 px-10 bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="flex flex-col lg:flex-row gap-20">
                <motion.div 
                    className="flex flex-col justify-between bg-gray-100/60 dark:bg-gray-800/60 p-7 rounded-4xl w-[310px] h-[293px] text-[#242424] dark:text-gray-200 hover:text-white transition-all duration-500 ease-in-out relative overflow-hidden group"
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: false, margin: "-100px" }}
                ...
                <div className="flex flex-row gap-25 max-w-[749px]">
                    <motion.div 
                        className="relative flex flex-col justify-between bg-primary dark:bg-blue-600 p-7 rounded-4xl w-[310px] h-[293px] text-white hover:text-primary dark:hover:text-blue-600 transition-all duration-500 ease-in-out group" 
                        style={{ transform: "rotate(-13deg)" }}
                        initial={{ opacity: 0, scale: 0.8, rotate: -13 }}
                    ...
                    <motion.div 
                        className="flex flex-col justify-between bg-gray-100/55 dark:bg-gray-800/60 p-7 rounded-4xl w-[310px] h-[293px] text-[#242424] dark:text-gray-200 hover:text-white transition-all duration-500 ease-in-out relative overflow-hidden group" 
