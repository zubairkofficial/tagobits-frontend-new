...
const Security = () => {
    return (
        <div className="flex flex-col items-center my-40 w-full lg:px-30 xl:px-30 bg-primary py-30 overflow-hidden">
            <ScrollFadeIn className="flex justify-center w-full py-10">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center pt-40 md:px-10 xl:px-20 gap-20 lg:gap-50">
                ...
                <ScrollFadeIn className="flex flex-col px-10 lg:px-0 lg:w-1/2 text-white">
            ...
            <ScrollFadeIn className="flex justify-center pt-20">
                <Button 
                    background="#ffffff" 
                    color="#235BB2" 
