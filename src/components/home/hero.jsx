...
import SplitTextLux from '../animations/SplitTextLux'
    ...
    return (
        <div className='relative bg-white dark:bg-gray-900 transition-colors duration-300'>
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
                <div className="w-[800px] h-[800px] bg-[radial-gradient(circle,_rgba(59,130,246,0.2)_0%,_transparent_70%)] dark:bg-[radial-gradient(circle,_rgba(59,130,246,0.3)_0%,_transparent_70%)] rounded-full"></div>
            </div>
            <div className="flex flex-col items-center gap-15 lg:gap-20 px-10">
                <SplitTextLux
                    text="The Digital Money for Borderless Payments"
                    className="text-[40px] sm:text-[52px] md:text-[60px] lg:text-[68px] xl:text-[72px] roboto-medium text-center max-w-[872px] leading-[1.1] text-primary dark:text-blue-400 flex w-full justify-center"
                    stagger={0.018}
                />
                <SplitTextLux
                    as="p"
                    text="The TagoBits platform enables payment settlement in seconds and at one tenth of the cost of traditional fiat payments."
                    className="text-[16px] sm:text-[18px] md:text-[20px] urbanist-regular text-center max-w-[780px] text-[#576275] dark:text-gray-400 flex w-full justify-center"
                    stagger={0.01}
                    delay={0.25}
                    duration={0.9}
                />
